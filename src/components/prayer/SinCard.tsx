...
interface SinCardProps {
  sin: any;
  onLogRelapse: (sin: any) => void;
  onConfess: (sin: any) => void;
  onToggleStatus: (sinId: string, currentStatus: string) => void;
  onDelete: (sinId: string) => void;
}
    ...
    return (
      <Card className="opacity-75 border-l-4 border-l-green-500">
        ...
        <CardContent>
          <Button 
            variant="outline" 
            size="sm"              onClick={() => onToggleStatus(sin._id, "conquered")}
          >
            Reactivate Struggle
          </Button>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-between pt-2 border-t gap-2">
            <Button 
              ...
              onClick={() => onToggleStatus(sin._id, "active")}
            >
